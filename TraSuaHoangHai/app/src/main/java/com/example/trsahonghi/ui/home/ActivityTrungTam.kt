...
//
//import com.example.trsahonghi.ui.user.ActivityDatHang
//import com.example.trsahonghi.ui.user.ActivityThongTin
...
//
//class ActivityTrungTam : AppCompatActivity() {
////    private lateinit var binding: ActivityTrungTamBinding
////    private var dsTP = mutableListOf<LoaiTp>()
////    private var dsDonhang = mutableListOf<BubbleTea>()
////    private var filteredDs = mutableListOf<BubbleTea>()
////    private var ds = mutableListOf<BubbleTea>()
...
////        ds_mh.add(MonHot(R.drawable.ic_best_sell_1))
...
////            )
////        )
////        ds.add(BubbleTea(R.drawable.trasuachanchauthachzaizai, "Trà sữa panđa", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.ic_best_sell_1, "Trà sữa 3 anh em", 20000, 0, 0))
////        ds.add(BubbleTea(R.drawable.ic_best_sell_1, "Trà sữa hoàng gia kem phomai", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.trasuachanchauthachluu, "Trà sữa thạch lựu", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.trasua3loai, "Trà sữa trân châu + milo", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.trasua3loai, "Trà sữa trân châu + soda", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.trasua3loai, "Trà sữa chân châu + lô hội", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.trasuamattra, "Trà sữa chân châu + mattra", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.trasuadaumatra, "Kem tươi mattra", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.trasuadaumatra, "Trà sữa chân châu vải", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.trasuaduahau, "Trà sữa chân châu dưa hấu", 20000, 0, -1))
////        ds.add(BubbleTea(R.drawable.sodabacha, "Sođa bạc hà ", 15000, 0, -1))
////        ds.add(BubbleTea(R.drawable.sodavietquat, "Sođa việt quất ", 15000, 0, -1))
////        ds.add(BubbleTea(R.drawable.suachuadautay, "sữa chua dâu tây ", 15000, 0, -1))
////        ds.add(BubbleTea(R.drawable.suachuavietquat, "sữa chua việt quất ", 15000, 0, -1))
////
////    }
////
////    private fun addRV() {
