...
//        val gson = Gson()
//        val type = object : TypeToken<List<BubbleTea>>() {}.type
//        dsDonhang = gson.fromJson<List<BubbleTea>>(dsDonHangJson, type) as MutableList<BubbleTea>
...
//        val Donhang =
//            Oder(dsDonhang, DonHangId, name, formattedDate, sdt, "2", tongTien.toString())
//
